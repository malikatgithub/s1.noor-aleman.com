            ...
            <div class="col-md-12 text-right">
                 ...
                 <div class="card border-top-0">
                        <div class="card-header border-top1">
                          <h6 class=" font-weight-bold"> إضافة بيانات ترحيل </h6>
                        </div>
                            <br>
                            <div class="container">
                {{-- Start of form  --}}
                            <form action="{{route('bus.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card flex-row flex-wrap">
                                    ...
                                    <div class="card-footer w-100 text-muted border-top1">
                                           <h6 class=" font-weight-bold text-dark"> بيانات الترحيل للعام الدراسي : <span class="text-danger"> {{$academic_year_name}} </span> </h6>
                                    </div>
                        ...
                        {{-- Row of class information --}}
                                        ...
                                        <div class="row ">
                                                ...
                                                <div class="col-md-6 mb-6">
                                                        <label for="validationDefault01"> المبلغ <span class="required">*</span></label>
                                                ...
                                                <div class="col-md-12 mb-12">
                                                                ...
                                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="" name="note">none</textarea>
                                                </div>
