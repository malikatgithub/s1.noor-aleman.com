                 ...
                 <div class="card border-top-0">
                    ...
                    {{-- Sesion Error and Success handeler --}}
                        ...
                        <div class="card-header border-top1">
                                <span class=" fa-1x font-weight-bold text-muted"><i class="fas fa-file-invoice-dollar"></i> إضافة بيانات الأقساط </span>
                        </div>
                            <br>
                            <div class="container">
                {{-- Start of form  --}}
                            <form action="{{route('fees_type.store')}}" method="POST" enctype="multipart/form-data">
                                {{@csrf_field()}}
                        ...
                        {{-- Row of income information --}}
                                        ...
                                        <div class="row ">
                                                ...
                                                <div class="col-md-6 mb-6">
                                                        <label for="validationDefault01">العام الدراسي</label>
                                                        <input type="text" class="form-control" id="validationDefault01" placeholder="auto_added"  required readonly >
                                                </div>
                                        ...
                                        <div class="row mt-3">
                                                ...
                                                <div class="col-md-4 mb-6">
                                                        ...
                                                        <input type="date" class="form-control" id="validationDefault01" placeholder="" value="" required name="date" >
                                                </div>
                                                ...
                                                <div class="col-md-12 mb-12">
                                                                ...
                                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="" name="fees_note"></textarea>
                                                </div>
