                 ...
                 <div class="card border-top-0">
                    ...
                    {{-- Sesion Error and Success handeler --}}
                        ...
                        <div class="card-header border-top1">
                                <span class=" fa-1x font-weight-bold text-muted"><i class="fas fa-file-invoice-dollar"></i> إضافة بيانات إيراد </span>
                        </div>
                            <br>
                            <div class="container">
                {{-- Start of form  --}}
                        ...
                        {{-- Row of income information --}}
                                        ...
                                        <div class="row ">
                                                <div class="col-md-6 mb-6">
                                                        <label for="validationDefault01">إسم الإيراد <span class="required">*</span> </label>
                                                        <input type="text" class="form-control" id="validationDefault01" placeholder=""  required name="name" value="{{$income->name}}">
                                                </div>
                
                
                                                <div class="col-md-6 mb-6">
                                                        <label for="validationDefault01">القيمة<span class="required">*</span></label>
                                                        <input type="number" class="form-control" id="validationDefault01" placeholder="" value="{{$income->amount}}" required name="amount" >
                                                </div>
                                                ...
                                                <div class="col-md-12 mb-12">
                                                                ...
                                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="" name="income_note">{{$income->income_note}}</textarea>
                                                </div>
