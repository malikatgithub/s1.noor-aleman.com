                ...
                {{-- Sesion Error and Success handeler --}}
                 ...
                 <div class="card border-top-0">
                        ...
                        <br>
                            ...
                            <div class="container">
                                {{-- Start of form  --}}
                            <form action="{{route('bus_payment.update', ['id' => $payment->id])}}" method="POST" target="" enctype="multipart/form-data">
                                {{@csrf_field()}}
                             ...
                             <h3 class="text-danger text-right font-weight-bold mb-5">  <i class="fas fa-exclamation-triangle fa-1x"></i>&nbsp; آخر تاريخ تسديد رسوم :  </h3>
                                        ...
                                        <div class="form-row">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="hidden" class="form-control" id="validationDefault01" placeholder="" value="{{$student->id}}" readonly required name="">
                                                </div>
                                            ...
                                            <div class="form-row  mt-5 mb-4">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                        ...
                                                        <select name="bus_type_id" id="bus_type_id" class="form-control input-md dynamic" data-dependent="amount" required>
                                                                ...
                                                                @if ($payment->bus_types_id == $bus->id)
                                                ...
                                                <div class="col-md-4 mb-3">
                                                        ...
                                                        <label for="validationDefault01">أختر  الشهر <span class="required">*</span> </label>
                                                                ...
                                                                @php
                                                                        $monthes = array('يناير', 'فبراير', 'مارس', 'أبريل', 'مايو', 'يونيو', 'يوليو', 'أغسطس', 'سبتمبر', 'أكتوبر', 'نوفمبر','ديسمبر');
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="number" class="form-control" id="validationDefault01" placeholder=""   required name="paid" value="{{$payment->paid}}">
                                                    </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 mb-12">
                                                        <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"  name="fees_note" placeholder="تخفيضات وغيرها">{{ $payment->fees_note}} </textarea>
                                                        </div>
                                                </div>
                                            </div>
