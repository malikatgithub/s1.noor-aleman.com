    ...
    <div class="row justify-content-center">
        <div class="col-md-11 text-right font-weight-light">
            ...
            <div class="card mb-3">
                ...
                <div class="container">
                    <label for="validationDefault01" class=" font-weight-bold">  تقرير واردات و صرف في تاريخ معينة </label>
                    <hr>
                    <div class="mt-2">
                        <form action="{{route('treasury.report_print')}}" method="POST" enctype="multipart/form-data">
                            {{@csrf_field()}}
                ...
                <br>
                        ...
                        <div class="container">
                            <label for="validationDefault01" class=" font-weight-bold"> تقرير واردات وصرف في الفترة معينة</label>
                            <hr>
                                ...
                                <form action="{{route('treasury.report_print')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row container mt-4">
                                            ...
                                            <div class="col-md-1 text-center mt-2">
                                                    <span class=" font-weight-bold text-dark">ـــ</span>
                                                </div>
