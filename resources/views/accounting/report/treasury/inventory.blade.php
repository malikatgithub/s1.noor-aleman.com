    ...
    <div class="row justify-content-center">
        <div class="col-md-11 text-right font-weight-light">
            ...
            <div class="card mb-3">
                ...
                <div class="container">
                    <label for="validationDefault01" class=" font-weight-bold">  تقرير الخزينة في يوم معين   </label>
                    <hr>
                    <div class="mt-2">
                        <form action="{{route('inventory.report_print')}}" method="POST" enctype="multipart/form-data">
                            {{@csrf_field()}}
                    ...
                    <br>
                        ...
                        <div class="container">
                            <label for="validationDefault01" class=" font-weight-bold"> تقرير الخزينة في الفترة معينة</label>
                            <hr>
