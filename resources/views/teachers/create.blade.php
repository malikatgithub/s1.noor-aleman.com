            ...
            <div class="col-md-12 text-right">
                 ...
                 <div class="card border-top-0">
                        <div class="card-header border-top1 font-weight-bold">
                                <i class="fas fa-user-plus"></i> &nbsp; إضافة بيانات مدرس 
                        </div>
                            <br>
                            <div class="container">
                {{-- Start of form  --}}
                        ...
                        {{-- Row of teacher information --}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="email" class="form-control" id="validationDefault01" placeholder="إختياري" value=""  name="email" >
                                            </div>

                                             <div class="col-md-3 mb-3">
                                                    <label for="validationDefault01">تحميل صورة</label>
                                                    <input type="file" class="form-control" id="validationDefault01" placeholder="إختر الصورة" value=""  name="pic">
                                            </div> 
