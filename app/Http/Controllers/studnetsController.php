...
try {
        ...
        // ]);
            ...
            $student = new Student;
            $student->academic_years_id =  $request->academic_year_id;
            ...
            $student->pic = '/upload/posts/'.$pic_new_name;
 ...
 return redirect()->route('students')->with('success', 'تمت إضافة الطالب بنجاح.');
       ...
       //echo $ex;
       return redirect()->route('students')->with('delete', 'الرجاء البحث عن استماره الطالب للتاكد من الإضافة.');
    ...
    public function update(Request $request, $id)
    {
		...
		DB::table('fees')->where('reg_no',$student->reg_no)->update(array(
                                 'class_id'=>$request->class_id,
		));
